...
type RandomselectionEntity struct {
	name    string
	client  *core.FreeMealSDK
...
func NewRandomselectionEntity(client *core.FreeMealSDK, entopts map[string]any) *RandomselectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RandomselectionEntity) GetName() string { return e.name }
...
func (e *RandomselectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RandomselectionEntity) Deleted() bool {
	return e.deleted
}


func (e *RandomselectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRandomselectionEntity(e.client, opts)
}

func (e *RandomselectionEntity) Data(args ...any) any {
...
func (e *RandomselectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Randomselection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RandomselectionEntity) DataTyped(data ...Randomselection) Randomselection {
	if len(data) > 0 {
		return typedFrom[Randomselection](e.Data(asMap(data[0])))
	}
	return typedFrom[Randomselection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Randomselection (all fields
// optional at the wire level).
func (e *RandomselectionEntity) MatchTyped(match ...Randomselection) Randomselection {
	if len(match) > 0 {
		return typedFrom[Randomselection](e.Match(asMap(match[0])))
	}
	return typedFrom[Randomselection](e.Match())
}
...
func (e *RandomselectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RandomselectionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RandomselectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RandomselectionListMatch and returns []Randomselection. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RandomselectionEntity) ListTyped(reqmatch RandomselectionListMatch, ctrl map[string]any) ([]Randomselection, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Randomselection](res), nil
}



func (e *RandomselectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RandomselectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RandomselectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RandomselectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
