...
The Golang SDK for the FreeMeal API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/free-meal-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/free-meal-sdk=../path/to/github.com/voxgig-sdk/free-meal-sdk
```
...
```
github.com/voxgig-sdk/free-meal-sdk/
...
The root package (`github.com/voxgig-sdk/free-meal-sdk`) re-exports everything needed
