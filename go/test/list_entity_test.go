...
func TestListEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set FREEMEAL_TEST_LIST_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func listBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FREEMEAL_TEST_LIST_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FREEMEAL_TEST_LIST_ENTID"])
