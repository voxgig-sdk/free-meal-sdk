...
const testSeed = `map[string]any{"entity": map[string]any{"category": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "filter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "latest": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lookup": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "random": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "randomselection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
