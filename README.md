...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-meal` | `npm install @voxgig-sdk/free-meal` |
| Python | `voxgig-sdk-free-meal` | `pip install voxgig-sdk-free-meal` |
| PHP | `voxgig-sdk/free-meal` | `composer require voxgig-sdk/free-meal` |
| Golang | `github.com/voxgig-sdk/free-meal-sdk/go` | `go get github.com/voxgig-sdk/free-meal-sdk/go` |
| Ruby | `voxgig-sdk-free-meal` | `gem install voxgig-sdk-free-meal` |
| Lua | `voxgig-sdk-free-meal` | `luarocks install voxgig-sdk-free-meal` |
