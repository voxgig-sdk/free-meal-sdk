...
from freemeal_sdk.core.spec import FreeMealSpec
from freemeal_sdk.core.result import FreeMealResult
from freemeal_sdk.core.response import FreeMealResponse
from freemeal_sdk.core.operation import FreeMealOperation
from freemeal_sdk.core.error import FreeMealError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FreeMealSDK.test(None, None)
        ...
        class TestInitFeature(FreeMealBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreeMealBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreeMealSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreeMealSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreeMealSDK.test(None, setup_opts)
