...
class FreeMealTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMealTestRunner.getenv("FREE_MEAL_TEST_LIVE")
        override = FreeMealTestRunner.getenv("FREE_MEAL_TEST_OVERRIDE")
        ...
        explain = FreeMealTestRunner.getenv("FREE_MEAL_TEST_EXPLAIN")
