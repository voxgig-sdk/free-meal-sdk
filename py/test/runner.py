...
class FreeMealTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMealTestRunner.getenv("FREEMEAL_TEST_LIVE")
        override = FreeMealTestRunner.getenv("FREEMEAL_TEST_OVERRIDE")
        ...
        explain = FreeMealTestRunner.getenv("FREEMEAL_TEST_EXPLAIN")
