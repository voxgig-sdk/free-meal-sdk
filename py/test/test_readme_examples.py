# FreeMeal SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeMealSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeMealSDK(...) and FreeMealSDK.test(...) become
#      FreeMealSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freemeal_sdk"
_SDK_CLASS = "FreeMealSDK"
