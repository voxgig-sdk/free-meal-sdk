...
from freemeal_sdk.utility import register

# Load features
from freemeal_sdk.feature.base_feature import FreeMealBaseFeature
from freemeal_sdk.features import _has_feature, _make_feature
...
class FreeMealSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreeMealUtility()
        self._utility = utility

        from freemeal_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreeMealUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "FreeMealSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeMealSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Category(self, data=None) -> "CategoryEntity":
        ...
        from freemeal_sdk.entity.category_entity import CategoryEntity
    ...
    def Filter(self, data=None) -> "FilterEntity":
        ...
        from freemeal_sdk.entity.filter_entity import FilterEntity
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from freemeal_sdk.entity.random_entity import RandomEntity
    ...
    def Randomselection(self, data=None) -> "RandomselectionEntity":
        ...
        from freemeal_sdk.entity.randomselection_entity import RandomselectionEntity
        return RandomselectionEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from freemeal_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FreeMealSDK":
        if sdkopts is None:
            sdkopts = {}
