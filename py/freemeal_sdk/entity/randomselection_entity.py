...
from freemeal_sdk.freemeal_types import (
    Randomselection,
...
class RandomselectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RandomselectionEntity(self._client, opts)
    ...
    def data_get(self) -> Randomselection:
    ...
    def match_get(self) -> Randomselection:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Randomselection]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Randomselection().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
