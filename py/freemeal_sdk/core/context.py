...
from freemeal_sdk.core.control import FreeMealControl
...
from freemeal_sdk.core.helpers import get_ctx_prop, to_map
...
class FreeMealContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, FreeMealResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeMealResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeMealError(code, msg, self)
