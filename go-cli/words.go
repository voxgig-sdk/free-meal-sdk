...
func registerSDKWords(r *eng.Registry, client *sdk.FreeMealSDK) {
...
func runOp(client *sdk.FreeMealSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
