...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FreeMealOmni.make_runner(TEST_JSON_FILE, FreeMealSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FreeMealOmni.errify(err)
    end
