...
class FreeMealRbacFeature extends FreeMealBaseFeature
{
    ...
    private function _required(FreeMealContext $ctx): ?string
    {
    ...
    private function _reject(FreeMealContext $ctx, string $required): void
    {
    ...
    private function _track(FreeMealContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
