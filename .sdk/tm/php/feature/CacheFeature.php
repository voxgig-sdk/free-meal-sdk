...
class FreeMealCacheFeature extends FreeMealBaseFeature
{
    ...
    private function _through(FreeMealContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
