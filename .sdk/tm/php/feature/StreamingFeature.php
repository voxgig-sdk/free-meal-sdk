...
// FreeMeal SDK streaming feature
...
class FreeMealStreamingFeature extends FreeMealBaseFeature
{
    ...
    private function _iterate(FreeMealResult $result): \Generator
    {
    ...
    private function _streamable(FreeMealContext $ctx): bool
    {
