...
class FreeMealProxyFeature extends FreeMealBaseFeature
{
    ...
    public function init(FreeMealContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeMealContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
