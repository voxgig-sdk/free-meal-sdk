...
// FreeMeal SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FreeMealOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FreeMealOmni::structfix($now, Struct::undef()))
                        !== json_encode(FreeMealOmni::structfix($val, Struct::undef()))) {
