...
class FreeMealTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMealTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeMealTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeMealTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
