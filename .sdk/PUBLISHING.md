...
|---|---|---|
| `ts/` | @voxgig-sdk/free-meal-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-meal-sdk \
      --repository voxgig-sdk/free-meal-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-meal-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-meal-sdk --id=<id>` removes it.
