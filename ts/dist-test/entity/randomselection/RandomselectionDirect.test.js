...
(0, node_test_1.describe)('RandomselectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-randomselection', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-randomselection', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FREE_MEAL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'FREE_MEAL_TEST_RANDOMSELECTION_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.FreeMealSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.FREE_MEAL_APIKEY,
        }));
        let idmap = env['FREE_MEAL_TEST_RANDOMSELECTION_ENTID'];
    ...
    const client = new __1.FreeMealSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RandomselectionDirect.test.js.map