...
describe("FilterEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FREEMEAL_TEST_FILTER_ENTID JSON to run live")
      return
    end
...
function filter_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FREEMEAL_TEST_FILTER_ENTID")
