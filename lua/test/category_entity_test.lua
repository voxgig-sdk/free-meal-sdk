...
describe("CategoryEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FREE_MEAL_TEST_CATEGORY_ENTID JSON to run live")
      return
    end
...
function category_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FREE_MEAL_TEST_CATEGORY_ENTID")
