...
describe("LatestDirect", function()
  it("should direct-list-latest", function()
    local setup = latest_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-latest", setup.live and "live" or "unit")
