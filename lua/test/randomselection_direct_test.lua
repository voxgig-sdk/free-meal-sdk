...
describe("RandomselectionDirect", function()
  it("should direct-list-randomselection", function()
    local setup = randomselection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-randomselection", setup.live and "live" or "unit")
...
function randomselection_direct_setup(mockres)
