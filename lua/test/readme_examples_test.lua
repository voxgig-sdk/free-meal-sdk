...
local SDK_MODULE = "free-meal_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["category"] = { ["test01"] = { id = "test01" } }, ["filter"] = { ["test01"] = { id = "test01" } }, ["latest"] = { ["test01"] = { id = "test01" } }, ["list"] = { ["test01"] = { id = "test01" } }, ["lookup"] = { ["test01"] = { id = "test01" } }, ["random"] = { ["test01"] = { id = "test01" } }, ["randomselection"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } } } }'
