-- FreeMeal SDK Randomselection entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RandomselectionEntity = {}
RandomselectionEntity.__index = RandomselectionEntity


function RandomselectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RandomselectionEntity)
  self._name = "randomselection"
  self._client = client
...
function RandomselectionEntity:get_name()
  return self._name
end


function RandomselectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RandomselectionEntity.new(self._client, opts)
end
...
function RandomselectionEntity:mark_deleted()
  self._deleted = true
end


function RandomselectionEntity:deleted()
  return true == self._deleted
end


function RandomselectionEntity:data_set(args)
  if args ~= nil then
...
function RandomselectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RandomselectionEntity:match_set(args)
  if args ~= nil then
...
function RandomselectionEntity:match_get()
...
function RandomselectionEntity:stream(action, args, callopts)
...
---@param reqmatch RandomselectionListMatch
---@param ctrl? table
---@return Randomselection[]
---@return string? err
function RandomselectionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function RandomselectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
