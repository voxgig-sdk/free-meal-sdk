...
module FreeMealTestRunner
  ...
  def self.env_override(m)
    live = getenv("FREE_MEAL_TEST_LIVE")
    override = getenv("FREE_MEAL_TEST_OVERRIDE")
    ...
    explain = getenv("FREE_MEAL_TEST_EXPLAIN")
    m["FREE_MEAL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FreeMealTestRunner
Helpers = FreeMealHelpers
Vs = VoxgigStruct
