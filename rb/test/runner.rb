...
module FreeMealTestRunner
  ...
  def self.env_override(m)
    live = getenv("FREEMEAL_TEST_LIVE")
    override = getenv("FREEMEAL_TEST_OVERRIDE")
    ...
    explain = getenv("FREEMEAL_TEST_EXPLAIN")
    m["FREEMEAL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
