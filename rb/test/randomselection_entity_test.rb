...
class RandomselectionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FREEMEAL_TEST_RANDOMSELECTION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def randomselection_basic_setup(extra)
  ...
  entid_env_raw = ENV["FREEMEAL_TEST_RANDOMSELECTION_ENTID"]
