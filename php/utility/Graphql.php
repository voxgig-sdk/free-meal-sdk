...
class FreeMealGraphql
{
    ...
    // equivalent.
    public static function body(FreeMealContext $ctx): mixed
    {
    ...
    public static function errors(FreeMealContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
