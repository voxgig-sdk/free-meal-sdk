...
// FreeMeal SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeMealMakeRequest
{
    public static function call(FreeMealContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeMealResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeMealResponse($fetched);
        } else {
