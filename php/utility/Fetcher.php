...
// FreeMeal SDK utility: fetcher

class FreeMealFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeMealSDK/1.0)';
    ...
    public static function call(FreeMealContext $ctx, string $fullurl, array $fetchdef): array
    {
