...
class FreeMealTimeoutFeature extends FreeMealBaseFeature
{
    ...
    private function _with_timeout(FreeMealContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeMealContext $_ctx, float $ms): void
    {
        $client = $this->client;
