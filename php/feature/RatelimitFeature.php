...
// FreeMeal SDK ratelimit feature
...
class FreeMealRatelimitFeature extends FreeMealBaseFeature
{
    ...
    private function _acquire(FreeMealContext $ctx): void
    {
    ...
    private function _track(FreeMealContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
