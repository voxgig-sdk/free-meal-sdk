...
// FreeMeal SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreeMealTestFeature extends FreeMealBaseFeature
{
    ...
    public function init(FreeMealContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreeMealContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreeMealContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreeMealContext $ctx, $op, $args): array
    {
