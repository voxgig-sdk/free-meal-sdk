...
// FreeMeal SDK clienttrack feature
...
class FreeMealClienttrackFeature extends FreeMealBaseFeature
{
    ...
    public function PostConstruct(FreeMealContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeMeal-SDK';
