...
class RandomEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREE_MEAL_TEST_RANDOM_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function random_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREE_MEAL_TEST_RANDOM_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["FREE_MEAL_TEST_RANDOM_ENTID"]);
