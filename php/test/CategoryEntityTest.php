...
class CategoryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREE_MEAL_TEST_CATEGORY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function category_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREE_MEAL_TEST_CATEGORY_ENTID");
