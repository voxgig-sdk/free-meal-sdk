...
// FreeMeal SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeMealSDK::test)
...
{
    private const SDK_CLASS = 'FreeMealSDK';
    ...
    private const SDK_BASE = 'freemeal_sdk';
