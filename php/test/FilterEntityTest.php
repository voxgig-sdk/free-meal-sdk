...
class FilterEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREEMEAL_TEST_FILTER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function filter_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREEMEAL_TEST_FILTER_ENTID");
