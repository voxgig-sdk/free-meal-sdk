...
{
    public function test_direct_list_latest(): void
    {
        $setup = latest_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-latest", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
